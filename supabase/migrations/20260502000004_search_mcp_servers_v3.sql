-- Extend search_mcp_servers to hide community submissions pending admin review
-- and quarantined entries. Approve sets score_status='scored'; reject sets is_quarantined=true.
